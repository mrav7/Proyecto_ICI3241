...
public class Menu {    
    ...
    // Clase sin uso, reemplazada por interfaz gráfica    
    ...
    public void menuCarga(ClienteData dataCliente, EquipoData dataEquipo, PlanData dataPlan) throws IOException {
        ...
        switch(opcion) {                         
            case 1:
                dataEquipo.ingresarEquipos();
                break;                            
            case 2: 
                dataPlan.ingresarPlanes();
                break;                            
            case 3:
                dataCliente.ingresarEquiposClientes();
                break;
            case 4:
                dataCliente.ingresarPlanesClientes();
                break;
            case 5:
                break;
            default:                            
    ...
    public void menuBusqueda(EquipoData dataEquipo, PlanData dataPlan) throws IOException {
        ...
        switch (opcion) {
            case 1:
                dataEquipo.buscarEquipoRangoPrecioPlan(consultarRangoEquipo());
                break;
            case 2:
    ...
    public void menuExportar(ClienteData dataCliente, EquipoData dataEquipo, PlanData dataPlan) throws IOException {
        ...
        switch(opcion) {
            case 1:
                dataCliente.exportarArchivoTXT();
                break;
            case 2:
